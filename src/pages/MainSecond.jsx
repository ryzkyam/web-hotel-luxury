        ...
        <div className="flex gap-10 flex-wrap justify-center">
          ...
          <div className="card w-80 glass">
            ...
            <div className="card-body">
              ...
              <p className="text-center">
                Pengalaman luar biasa, sangat memuaskan! Pemandangan yang indah
          ...
          <div className="card w-80 glass">
            ...
            <div className="card-body">
              ...
              <p className="text-center">
                Sangat menyenangkan! Perjalanan saya menjadi lebih mudah dengan
                platform ini.
              </p>
            </div>
          </div>
          ...
          <div className="card w-80 glass">
            ...
            <div className="card-body">
              ...
              <p className="text-center">
                Saya sangat merekomendasikan! Aplikasinya mudah digunakan dan
                sangat membantu.
              </p>
            </div>
          </div>
        ...
        <div className="flex gap-10 flex-wrap justify-center mt-10">
          ...
          <div className="card w-80 glass">
            ...
            <div className="card-body">
              ...
              <p className="text-center">
                Fasilitas yang ditawarkan sangat baik, dan perjalanan saya
          ...
          <div className="card w-80 glass">
            ...
            <div className="card-body">
              ...
              <p className="text-center">
                Saya sangat menikmati pengalaman ini. Akan menggunakan layanan
